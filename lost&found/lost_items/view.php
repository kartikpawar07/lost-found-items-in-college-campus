...
try {
    $stmt = $pdo->prepare("SELECT * FROM lost_items WHERE user_id = ? ORDER BY id DESC");
...
<div class="d-flex justify-content-between align-items-center mb-4 flex-wrap gap-2">
    <h3 class="fw-bold text-primary mb-0"><i class="bi bi-question-circle-fill me-2 text-danger"></i>My Reported Lost Items</h3>
    <a href="<?php echo BASE_URL; ?>lost_items/add.php" class="btn btn-danger btn-sm">
        <i class="bi bi-plus-circle me-1"></i>Report New Lost Item
    </a>
</div>
